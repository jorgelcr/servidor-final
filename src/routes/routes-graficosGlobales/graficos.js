...
const { get_TotalEvidencias, get_TotalEvidenciasUnidades, get_TotalEvidenciasTiposRegistros, get_TotalEvidenciasDebilidades, get_TotalEvidenciasCriterios, get_TotalEvidenciasAmbitoAcademico, get_TotalEvidenciasAprobadasRechazadas, get_TotalUsuarios } = require('../../controllers/graficos-globales/graficos.controllers');
